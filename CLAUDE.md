...
- Python 3.11+ + FastAPI + SQLModel + PyJWT + Pydantic (001-phase-ii-specs - backend)
...
- 001-phase-ii-specs: Added Phase II full-stack technologies (Next.js 15, FastAPI, Neon PostgreSQL, JWT authentication)
